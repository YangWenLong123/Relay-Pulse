...
export function publicRelay(relay) {
    ...
    return {
        ...
        balanceConfig: balanceConfig
            ? {
                template: balanceConfig.template,
                requestUrl: balanceConfig.requestUrl,
                userId: balanceConfig.userId,
                timeout: balanceConfig.timeout,
                intervalMinutes: balanceConfig.intervalMinutes,
                enabled: balanceConfig.enabled,
                apiKeyConfigured: Boolean(balanceConfig.apiKey),
                accessTokenConfigured: Boolean(balanceConfig.accessToken)
            }
            : undefined
    };
}
