...
import { endpointUrl, maskApiKey, normalizeBaseUrl } from '../src/extension/relay-utils';

describe('extension relay URL utilities', () => {
  ...
  it('does not duplicate v1', () => {
    ...
    expect(endpointUrl('https://api.example.com/openai', '/v1/responses')).toBe('https://api.example.com/openai/v1/responses');
